    ...
    <Tooltip>
      <TooltipTrigger asChild>
        ...
        >
          ...
          />
          {/* Only show text on mobile/tablet */}
          {isMobileOrTablet && (
            <span className="ml-1.5 font-medium text-sm">Attach</span>
          )}
        </button>
      </TooltipTrigger>
...
// ReasonButton component (removed by request)
