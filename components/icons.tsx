...
export const CustomChevronsLeft = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" data-rtl-flip="" className={"icon max-md:hidden " + (props.className || "")} {...props}>
...
export const ButtonIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className={"icon " + (props.className || "")} aria-hidden="true" {...props}>
...
export const SpinnerIcon = ({ size = 24, className }: { size?: number, className?: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      // Use clsx to merge the default class with the provided className
