...
// START: New Social Icon Components
export const XIcon = ({ size = 20, className = "", ...props }: { size?: number; className?: string } & React.SVGProps<SVGSVGElement>) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// START: New Social Icon Components
export const InstagramIcon = ({ size = 20, className = "", ...props }: { size?: number; className?: string } & React.SVGProps<SVGSVGElement>) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
    <path d="M12 2.163c3.29 0 3.674.012 4.95.071 1.268.059 2.361.276 3.229.652a5.91 5.91 0 0 1 2.14 1.736 5.91 5.91 0 0 1 1.736 2.14c.376.868.593 1.961.652 3.229.059 1.276.071 1.66.071 4.95s-.012 3.674-.071 4.95c-.059 1.268-.276 2.361-.652 3.229a5.91 5.91 0 0 1-1.736 2.14 5.91 5.91 0 0 1-2.14 1.736c-.868.376-1.961.593-3.229.652-1.276.059-1.66.071-4.95.071s-3.674-.012-4.95-.071c-1.268-.059-2.361-.276-3.229-.652a5.91 5.91 0 0 1-2.14-1.736 5.91 5.91 0 0 1-1.736-2.14c-.376-.868-.593-1.961-.652-3.229-.059-1.276-.071-1.66-.071-4.95s.012-3.674.071-4.95c.059-1.268.276-2.361.652-3.229a5.91 5.91 0 0 1 1.736-2.14 5.91 5.91 0 0 1 2.14-1.736c.868-.376 1.961-.593 3.229-.652 1.276-.059 1.66-.071 4.95-.071zm0-2.163c-3.315 0-3.73.012-5.034.071-1.306.059-2.489.276-3.478.653-1.065.378-1.975.889-2.785 1.698a7.914 7.914 0 0 0-1.698 2.785c-.377.989-.594 2.172-.653 3.478-.059 1.304-.071 1.719-.071 5.034s.012 3.73.071 5.034c.059 1.306.276 2.489.653 3.478.378 1.065.889 1.975 1.698 2.785a7.914 7.914 0 0 0 2.785 1.698c.989.377 2.172.594 3.478.653 1.304.059 1.719.071 5.034.071s3.73-.012 5.034-.071c1.306-.059 2.489-.276 3.478-.653 1.065-.378 1.975-.889 2.785-1.698a7.914 7.914 0 0 0 1.698-2.785c.377-.989.594-2.172.653-3.478.059-1.304.071-1.719.071-5.034s-.012-3.73-.071-5.034c-.059-1.306-.276-2.489-.653-3.478a7.914 7.914 0 0 0-1.698-2.785c-.81-.809-1.72-1.32-2.785-1.698-1.065-.377-2.172-.594-3.478-.653-1.304-.059-1.719-.071-5.034-.071zM12 6.746c-2.894 0-5.246 2.352-5.246 5.246s2.352 5.246 5.246 5.246 5.246-2.352 5.246-5.246-2.352-5.246-5.246-5.246zm0 8.292c-1.654 0-2.999-1.345-2.999-2.999s1.345-2.999 2.999-2.999 2.999 1.345 2.999 2.999-1.345 2.999-2.999 2.999zm6.406-7.707c-.653 0-1.182-.529-1.182-1.182s.529-1.182 1.182-1.182 1.182.529 1.182 1.182-.529 1.182-1.182 1.182z"></path>
  </svg>
);


export const LinkedInIcon = ({ size = 20, className = "", ...props }: { size?: number; className?: string } & React.SVGProps<SVGSVGElement>) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const DiscordIconSvg = ({ size = 20, className = "", ...props }: { size?: number; className?: string } & React.SVGProps<SVGSVGElement>) => (
  // Renamed to DiscordIconSvg to avoid conflict if you have a DiscordIcon elsewhere
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    {...props}
  >
    <path d="M20.317 4.369a19.791 19.791 0 00-4.885-1.515.074.074 0 00-.078.037c-.21.375-.444.864-.608 1.234a18.358 18.358 0 00-5.484 0 17.012 17.012 0 00-.608-1.234.074.074 0 00-.078-.037 19.736 19.736 0 00-4.885 1.515.068.068 0 00-.054.058A17.098 17.098 0 001.644 14.9a.074.074 0 00.037.084 19.902 19.902 0 005.286 2.487.074.074 0 00.084-.037c.456-.597.786-1.248.996-1.902a.074.074 0 00-.047-.084 14.645 14.645 0 01-1.588-.75.074.074 0 01-.015-.106l.001-.002c.09-.09.19-.18.296-.264a.074.074 0 01.09-.008c5.022 2.212 10.452 2.212 15.474 0a.074.074 0 01.09.008c.106.084.206.174.296.264l.001.002a.074.074 0 01-.015.106q-.02.011-.044.023a14.62 14.62 0 01-1.544.727.074.074 0 00-.047.084c.21.654.54 1.305.996 1.902a.074.074 0 00.084.037 19.902 19.902 0 005.286-2.487.074.074 0 00.037-.084 17.302 17.302 0 00-1.96-10.474.068.068 0 00-.054-.059zM8.03 15.025c-.94 0-1.71-.797-1.71-1.785s.77-1.785 1.71-1.785S9.74 12.472 9.74 13.24s-.77 1.785-1.71 1.785zm7.94 0c-.94 0-1.71-.797-1.71-1.785s.77-1.785 1.71-1.785S17.68 12.472 17.68 13.24s-.77 1.785-1.71 1.785z"></path>
  </svg>
);
