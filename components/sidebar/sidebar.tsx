...
const NewChatButton = () => {
  ...
  const handleNewChat = (e: React.MouseEvent) => {
    ...
    if (pathname === "/chat") {
      // If already on /chat, force a hard refresh
      window.location.href = "/chat"
    } else {
      // Navigate to /chat and force refresh
      router.push("/chat")
      router.refresh()
    }
  }
  ...
  return (
    <div className="px-2">
      <button
        ...
        className={clsx(
          // --- These are your exact visual styles ---
          ...
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring", // Good for accessibility
          {
...
export const Sidebar = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col h-full w-full" onClick={handleAsideClick}>
